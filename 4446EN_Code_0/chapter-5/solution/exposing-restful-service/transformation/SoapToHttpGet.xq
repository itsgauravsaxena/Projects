(:: pragma bea:global-element-parameter parameter="$retrieveCustomerByCriteriaResponse1" element="ns0:RetrieveCustomerByCriteriaResponse" location="../../consuming-restful-service/wsdl/CustomerServiceCRM.wsdl" ::)
